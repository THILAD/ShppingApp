...
export class OrderProductService {
    ...
    public List_vendor( limit: number,vendor:number ): Promise<any> {
        return this.orderProductRepository.List_vendor(limit,vendor);
    }
    ...
    public report_order( vendor:number,date_start:string,date_end:string,ticket_type:string): Promise<any> {
        return this.orderProductRepository.report_order(vendor,date_start,date_end,ticket_type);
    }
}
