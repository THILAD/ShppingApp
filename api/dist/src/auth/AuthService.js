...
const UserVendorRepository_1 = require("../api/repositories/UserVendorRepository");
const CustomerRepository_1 = require("../api/repositories/CustomerRepository");
const Logger_1 = require("../decorators/Logger");
let AuthService = class AuthService {
    constructor(log, userRepository, userVendorRepository, customerRepository) {
        this.log = log;
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (authorization) {
                ...
                if (authorization && authorization.split(' ')[0] === 'Bearer') {
                    ...
                    const User = yield this.decryptToken(authorization.split(' ')[1]);
    ...
    validateUserVendor(userId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            console.log('userId' + userId);
            const user = yield this.userVendorRepository.findOne({
                where: {
                    vendor_id: userId,
                },
            });
...
AuthService = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [Object, UserRepository_1.UserRepository,
        UserVendorRepository_1.UserVendorRepository,
