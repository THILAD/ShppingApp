...
tslib_1.__decorate([
    typeorm_1.Column({ name: 'user_vendor_id' }),
    tslib_1.__metadata("design:type", Number)
], AccessToken.prototype, "userVendorId", void 0);
tslib_1.__decorate([
...
tslib_1.__decorate([
    index_3.ManyToOne(type => User_Vendor_1.User_Vendor, user_vendor => user_vendor.accessToken, { nullable: true }),
    index_2.JoinColumn({ name: 'user_vendor_id' }),
    tslib_1.__metadata("design:type", User_Vendor_1.User_Vendor)
], AccessToken.prototype, "user_vendor", void 0);
tslib_1.__decorate([
