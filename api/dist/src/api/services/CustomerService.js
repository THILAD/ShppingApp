...
let CustomerService = class CustomerService {
    constructor(customerRepository, orderRepository, log) {
    ...
    customer_vendor(vendor) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.orderRepository.list_customer_vendor(vendor);
        });
    }
    // customer List
    ...
    list_vendor(limit, offset, search = [], whereConditions = [], order, count, vendor) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const condition = {};
            condition.where = [];
            const customer = yield this.orderRepository.list_customer_vendor(vendor);
