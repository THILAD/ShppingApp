...
let OrderService = class OrderService {
    ...
    list_vendor(limit, offset, select = [], search = [], whereConditions = [], relation = [], count, vendor) {
        const condition = {};
        if (select && select.length > 0) {
            condition.select = select;
        }
    ...
    // sales list
    salesList_vendor(vendor) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.orderRepository.salesList_vendor(vendor);
        });
    }
    // find today orders
    ...
    findAlltodayOrder_vendor(todaydate, vendor) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.orderRepository.findAllTodayOrder_vendor(todaydate, vendor);
        });
    }
    ...
    findAllTodayOrderCount_vendor(todaydate, vendor) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.orderRepository.findAllTodayOrderCount_vendor(todaydate, vendor);
        });
    }
};
