...
let CommonListController = class CommonListController {
    constructor(bannerService, categoryService, productRelatedService, productService, productImageService, languageService, countryService, contactService, emailTemplateService, zoneService, productToCategoryService, categoryPathService, pluginService, userService) {
            ...
            if (count) {
                ...
                const category = categoryData.map((value) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    ...
                    const child = yield this.categoryService.find({ where: { parentInt: value.categoryId, isActive: 1 },
                        select: ['categoryId', 'name', 'image', 'imagePath', 'parentInt', 'sortOrder', 'metaTagTitle', 'metaTagDescription', 'metaTagKeyword', 'isActive'] });
...
CommonListController = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [BannerService_1.BannerService, CategoryService_1.CategoryService, ProductRelatedService_1.ProductRelatedService,
        ...
        ProductToCategoryService_1.ProductToCategoryService, CategoryPathService_1.CategoryPathService, PluginService_1.PluginService, UserService_1.UserService])
