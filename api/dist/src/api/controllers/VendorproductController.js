...
let VendorProductController = class VendorProductController {
    constructor(productService, vendorService, productToCategoryService, productImageService, categoryService, orderProductService, orderService, productRelatedService, productViewLogService) {
     ...
     */
    productList(limit, offset, keyword, sku, status, price, count, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const productLists = yield this.productService.list_vendor(limit, offset, select, relation, WhereConditions, 0, price, count, user.id);
            if (count) {
                const successRes = {
                    status: 1,
     ...
     * HTTP/1.1 500 Internal Server Error
     */
    productminimum(limit, offset, keyword, sku, status, price, count, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const user = yield this.authService.parseBasicAuthFromRequest(request);
            ...
            const productLists = yield this.productService.list_item_minimum_vendor(limit, offset, select, relation, WhereConditions, 0, price, count, user.id, vendor.minimum);
            if (count) {
                const successRes = {
                    status: 1,
                    message: 'Successfully got count ',
    ...
    productDetail(id, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            productDetails.relatedProductDetail = yield this.productRelatedService.findAll({ where: { productId: id } }).then((val) => {
    ...
    topSellingProductList(request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const user = yield this.authService.parseBasicAuthFromRequest(request);
            const data = yield this.productService.recentProductSelling_vendor(4, user.id);
    ...
    sellingProduct(request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const user = yield this.authService.parseBasicAuthFromRequest(request);
            const limit = 3;
            const orderList = yield this.orderProductService.List_vendor(limit, user.id);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorProductController.prototype, "addProduct", null);
tslib_1.__decorate([
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorProductController.prototype, "productDetail", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorProductController.prototype, "topSellingProductList", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], VendorProductController.prototype, "sellingProduct", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorProductController.prototype, "updateTodayDeals", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorProductController.prototype, "productViewLogList", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorProductController.prototype, "customerProductView", null);
tslib_1.__decorate([
