...
let VendorOrderController = class VendorOrderController {
     ...
     */
    orderList(limit, offset, orderId, orderStatusId, customerName, totalAmount, dateAdded, count, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const orderList = yield this.orderService.list_vendor(limit, offset, select, search, WhereConditions, 0, count, user.id);
            if (count) {
                const Response = {
                    status: 1,
    ...
    orderDetail(orderid, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            orderData.productList = yield this.orderProductService.find({ where: { orderId: orderid }, select: ['orderProductId', 'orderId', 'productId', 'name', 'model', 'quantity', 'total', 'productPrice'] });
     ...
     * HTTP/1.1 500 Internal Server Error
     */
    salesList(response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const user = yield this.authService.parseBasicAuthFromRequest(request);
            const orderList = yield this.orderService.salesList_vendor(user.id);
     ...
     * HTTP/1.1 500 Internal Server Error
     */
    totalOrderAmount(response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let total = 0;
            const user = yield this.authService.parseBasicAuthFromRequest(request);
            const order = yield this.orderService.findAll_vendor(user.id);
            let n = 0;
     ...
     * HTTP/1.1 500 Internal Server Error
     */
    todayOrderAmount(response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const user = yield this.authService.parseBasicAuthFromRequest(request);
            ...
            let total = 0;
            const order = yield this.orderService.findAlltodayOrder_vendor(todaydate, user.id);
            let n = 0;
            for (n; n < order.length; n++) {
                total += +order[n].total;
            }
     ...
     * HTTP/1.1 500 Internal Server Error
     */
    orderCount(response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const user = yield this.authService.parseBasicAuthFromRequest(request);
            const nowDate = new Date();
            const todaydate = nowDate.getFullYear() + '-' + (nowDate.getMonth() + 1) + '-' + nowDate.getDate();
            const orderCount = yield this.orderService.findAllTodayOrderCount_vendor(todaydate, user.id);
            const successResponse = {
                status: 1,
                message: 'Successfully get Today order count',
                data: orderCount,
...
tslib_1.__decorate([
    ...
    tslib_1.__param(5, routing_controllers_1.QueryParam('totalAmount')), tslib_1.__param(6, routing_controllers_1.QueryParam('dateAdded')), tslib_1.__param(7, routing_controllers_1.QueryParam('count')), tslib_1.__param(8, routing_controllers_1.Req()), tslib_1.__param(9, routing_controllers_1.Res()),
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorOrderController.prototype, "salesList", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], VendorOrderController.prototype, "totalOrderAmount", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], VendorOrderController.prototype, "todayOrderAmount", null);
tslib_1.__decorate([
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorOrderController.prototype, "orderChangeStatus", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorOrderController.prototype, "excelOrderView", null);
tslib_1.__decorate([
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorOrderController.prototype, "deleteMultipleOrder", null);
