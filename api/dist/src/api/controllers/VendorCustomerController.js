...
let VendorCustomerController = class VendorCustomerController {
     ...
     * HTTP/1.1 500 Internal Server Error
     */
    customerList(limit, offset, name, status, email, customerGroup, date, count, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const search = [
                {
                    name: 'firstName',
            ...
            const customerList = yield this.customerService.list_vendor(limit, offset, search, WhereConditions, 0, count, user.id);
            const successResponse = {
                status: 1,
     ...
     * HTTP/1.1 500 Internal Server Error
     */
    recentCustomerList(request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const order = 1;
            const WhereConditions = [
                {
            ...
            const user = yield this.authService.parseBasicAuthFromRequest(request);
            const customerList = yield this.customerService.list_vendor(0, 0, 0, WhereConditions, order, 0, user.id);
            const successResponse = {
                status: 1,
                message: 'Successfully got Customer list.',
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorCustomerController.prototype, "deleteCustomer", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorCustomerController.prototype, "updateCustomer", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorCustomerController.prototype, "customerDetails", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorCustomerController.prototype, "recentCustomerList", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorCustomerController.prototype, "customerCount", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorCustomerController.prototype, "deleteMultipleCustomer", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorCustomerController.prototype, "excelCustomerView", null);
VendorCustomerController = tslib_1.__decorate([
    routing_controllers_1.JsonController('/vendor-customer'),
...
exports.VendorCustomerController = VendorCustomerController;
//# sourceMappingURL=VendorCustomerController.js.map